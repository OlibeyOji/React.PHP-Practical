                        ...
                        <div class="table-responsive">
                            <table id="attendance-tbl" class="table table-bordered">
                                ...
                                <thead class="bg-primary">
                                    <tr>
                                        <th class="text-center bg-transparent text-light">Workers</th>
                                        ...
                                        <th class="text-center bg-transparent text-light">Work Leave</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="5" class="px-2 py-1 text-center">No Worker Listed Yet</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
