                    ...
                    <div class="container-fluid">
                        <div class="row align-items-end">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <label for="class_id" class="form-label">Department</label>
                    ...
                    <div class="container-fluid">
                        <fieldset>
                            ...
                            <div class="ps-4">
                                ...
                                <div><span class="text-primary fw-bold">H</span> <span class="ms-1">= Work Leave</span></div>
                            </div>
                        </fieldset>
                    </div>
                </div>
                            ...
                            <table id="attendance-rpt-tbl" class="table table-bordered">
                                <thead>
                                    <tr class="bg-primary bg-opacity-75">
                                        <th class="text-center bg-primary text-light" style="width:300px !important">Workers</th>
                                ...
                                <tbody>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="<?= $monthLastDay + 5 ?>" class="px-2 py-1 text-center">No Worker Listed Yet</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
