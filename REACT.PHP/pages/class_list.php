                        ...
                        <table class="table table-bordered table-hovered table-stripped">
                            ...
                            <thead class="bg-dark-subtle">
                                <tr class="bg-transparent">
                                    ...
                                    <th class="bg-transparent text-center">Department Name - Subject</th>
...
<script>
    $(document).ready(function(){
        ...
        $('.delete_class').click(function(e){
            ...
            var id = $(this)[0].dataset?.id || ''
            start_loader()
            if(confirm(`Are you sure to delete the selected Department? This action cannot be undone.`) == true){
                $.ajax({
